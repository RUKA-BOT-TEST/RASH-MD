const {
  ...
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐆𝐑𝐎𝐔𝐏 𝐋𝐈𝐍𝐊2          
  ║ https://whatsapp.com/channel/0029VbAmpDr1iUxbOokrFK21                 
  ╠═════════════════╣
  ║      𝐑𝐀𝐒𝐇 𝐁𝐘𝐓𝐄 𝐌𝐃               
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝐑𝐀𝐒𝐇 Tech Team        
  ╚═════════════════╝
`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/4syeyx.jpg` }, caption: up })
